...
from course_discovery.apps.publisher.utils import get_users_organizations, is_internal_user
...
class CustomCourseForm(CourseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if user:
            self.declared_fields['organization'].queryset = get_users_organizations(user)
