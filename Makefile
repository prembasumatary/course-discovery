...
.PHONY: accept clean clean_static compile_translations detect_changed_source_translations dummy_translations extract_translations \
	...
	requirements start-devstack static stop-devstack test validate validate_translations static.dev static.watch
...
static: ## Gather all static assets for production
	cd course_discovery && $(NODE_BIN)/webpack --config webpack.config.js --display-error-details --progress --optimize-minimize
	python manage.py collectstatic --noinput
	python manage.py compress -v3 --force

static.dev:
	cd course_discovery && $(NODE_BIN)/webpack --config webpack.config.js --display-error-details --progress

static.watch:
	cd course_discovery && $(NODE_BIN)/webpack --config webpack.config.js --display-error-details --progress --watch
